...
> [!hint]
> Some Quartz features (like [[./RSS Feed|RSS Feed]] and sitemap generation) require `baseUrl` to be configured properly in your [[./configuration|configuration]] to work properly. Make sure you set this before deploying!
...
![[./docs/images/dns records.png|dns records.png]]_The above shows a screenshot of Google Domains configured for both `jzhao.xyz` (an apex domain) and `quartz.jzhao.xyz` (a subdomain)._
