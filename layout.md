...
| Layout                          | Preview                             |
| ------------------------------- | ----------------------------------- |
| Desktop (width > 1200px)        | ![[./docs/images/quartz-layout-desktop.png\|800]] |
| Tablet (800px < width < 1200px) | ![[./docs/images/quartz-layout-tablet.png\|800]]  |
| Mobile (width < 800px)          | ![[./docs/images/quartz-layout-mobile.png\|800]]  |
...
See [a list of all the components](./component.md#) for all available components along with their configuration options. Additionally, Quartz provides several built-in higher-order components for layout composition - see [[./layout-components|layout-components]] for more details.

You can also checkout the guide on [[./creating components|creating components]] if you're interested in further customizing the behaviour of Quartz.
