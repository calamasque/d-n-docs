...
> [!info] Info
>
> The `baseUrl` property in your [[./configuration|configuration]] must be set properly for social images to work correctly, as they require absolute paths.
...
| Light                                      | Dark                                      |
| ------------------------------------------ | ----------------------------------------- |
| ![[./docs/images/custom-social-image-preview-light.png|custom-social-image-preview-light.png]] | ![[./docs/images/custom-social-image-preview-dark.png|custom-social-image-preview-dark.png]] |
